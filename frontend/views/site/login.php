...
<div class="blankpage-form-field">
    ...
    <div style="background-color: white;opacity: 0.9;"
        ...
        <!--<div class="form-group">
            <div class="form-group field-loginform-tin_number required">
                <label class="control-label" for="loginform-tin_number">Tin Number</label>
                <input type="text" id="loginform-tin_number" class="form-control" name="tin_number"
                       autofocus="" placeholder="Tin Number" aria-required="true">
